...
with open('data/history_driver.csv', mode='r') as file:
...
with open('data/history_team.csv', mode='r') as file:
    csv_reader = csv.DictReader(file)
    team_data_list = []
    for row in csv_reader:
...
filename_3 = "data/history_race.csv"
...
filename_1 = "data/history_driver.csv"
...
filename_2 = "data/history_team.csv"
